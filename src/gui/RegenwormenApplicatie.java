...
public class RegenwormenApplicatie extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Label scoreLabel = new Label("speler - score");
        Text scores = new Text();
        scores.setText(dc.getHighScores());
        VBox topsBox = new VBox();
        VBox centerBox = new VBox();
        centerBox.getChildren().add(scores);
        centerBox.setAlignment(Pos.TOP_CENTER);
        topsBox.getChildren().add(scoreLabel);
        ...
        Alert voegToeAlert = new Alert(AlertType.ERROR);
        voegToeAlert.setHeaderText("Er zijn al 8 spelers: het spel is vol.");
        voegToe.setOnMouseClicked(e -> {
            if (dc.getAantalSpelers() < 8) {
        ...
        Alert naarSpelAlert = new Alert(AlertType.ERROR);
        naarSpelAlert.setHeaderText("Er is nog maar een speler, er moeten minstens twee spelers zijn.");
        ...
        dobbelBox.setAlignment(Pos.CENTER);
        ...
        Scene tegelScene = new Scene(tegelPane, 600, 400);
        ...
        highScoreButton.setOnMouseClicked(e -> window.setScene(highScoreScene));
        confirm.setOnMouseClicked(e -> {
            int count = dc.getAantalSpelers();
            if (dc.ControleerSpelerNaamEnWachtwoord(spelerNaamField.getText(), wwField.getText())) {
                switch (count) {
                    case 1:
                        speler2.setText(spelerNaamField.getText());
                        break;
                    case 2:
                        speler3.setText(spelerNaamField.getText());
                        break;
                    case 3:
                        speler4.setText(spelerNaamField.getText());
                        break;
                    case 4:
                        speler5.setText(spelerNaamField.getText());
                        break;
                    case 5:
                        speler6.setText(spelerNaamField.getText());
                        break;
                    case 6:
                        speler7.setText(spelerNaamField.getText());
                        break;
                    case 7:
                        speler8.setText(spelerNaamField.getText());
                        break;
                    default:
                        speler1.setText(spelerNaamField.getText());
                        break;
                }
